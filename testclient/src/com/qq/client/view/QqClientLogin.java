...
public class QqClientLogin extends JFrame implements ActionListener{
	...
	public QqClientLogin()
	{
		...
		jp2_jbl1=new JLabel("QQ号码",SwingConstants.CENTER);
		jp2_jbl2=new JLabel("QQ密码",SwingConstants.CENTER);
		jp2_jbl3=new JLabel("忘记密码",SwingConstants.CENTER);
		jp2_jbl3.setForeground(Color.blue);
		jp2_jbl4=new JLabel("申请密码保护",SwingConstants.CENTER);
